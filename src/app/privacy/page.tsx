...
export default function PrivacyPolicy() {
  return (
    <main className="min-h-screen flex flex-col">
      {/* Header */}
      <header className="bg-[var(--foreground)] text-[var(--background)] py-8 px-6">
        <div className="max-w-3xl mx-auto">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-sm text-[var(--gray-400)] hover:text-[var(--gold)] transition-colors mb-6"
          >
          ...
          <p className="text-[var(--gray-400)] text-sm mt-2">
      ...
      {/* Content */}
      <div className="flex-1 bg-[var(--gray-50)] py-12 px-6">
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <section>
            ...
            <p className="text-[var(--gray-700)] leading-relaxed mt-3">
          ...
          <section>
            ...
            <ul className="space-y-2 text-[var(--gray-700)] mt-3">
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-[var(--gold)] mt-2 flex-shrink-0" />
                <span>
